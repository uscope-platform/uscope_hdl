...
set design_name axi_to_axil_vip_bd
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net M_AXI_0_1 [get_bd_intf_ports M_AXI_0] [get_bd_intf_pins axi_vip_0/M_AXI]
  ...
  # Create address segments
   assign_bd_address -target_address_space /axi_vip_0/Master_AXI [get_bd_addr_segs M_AXI_0/Reg] -force
   set_property offset 0x400000000 [get_bd_addr_segs {axi_vip_0/Master_AXI/SEG_M_AXI_0_Reg}]
