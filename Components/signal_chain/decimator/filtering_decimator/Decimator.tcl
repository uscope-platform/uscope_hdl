...
################################################################
# This is a generated script based on design: Decimator
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.Input_Sample_Frequency {1.2} \
  ...
  connect_bd_intf_net -intf_net S_AXIS_DATA_0_1 [get_bd_intf_ports data_in] [get_bd_intf_pins cic_compiler_0/S_AXIS_DATA]
  ...
  connect_bd_intf_net -intf_net fir_compiler_0_M_AXIS_DATA [get_bd_intf_ports data_out] [get_bd_intf_pins fir_compiler_0/M_AXIS_DATA]

  # Create port connections
  connect_bd_net -net Clock_1 [get_bd_ports Clock] [get_bd_pins cic_compiler_0/aclk] [get_bd_pins fir_compiler_0/aclk]
