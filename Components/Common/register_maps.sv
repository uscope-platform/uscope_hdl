...
package reg_maps;
    ...
    class sd_filter #(parameter int NUM = 12);
        static function int tresh_l(int i); return i * 4; endfunction
        static function int tresh_h(int i); return (NUM + i) * 4; endfunction
