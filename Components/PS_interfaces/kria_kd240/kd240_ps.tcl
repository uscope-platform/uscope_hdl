...
\
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_ports fCore] [get_bd_intf_pins axi_smc/M00_AXI]
  ...
  connect_bd_net -net dma_done_1  [get_bd_ports dma_done] \
  ...
  assign_bd_address -offset 0x000400000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_out/Reg] -force
