...
set_property PACKAGE_PIN N6       [get_ports ph_spi_clk]       ;# HPA00_P 1.8V
set_property PACKAGE_PIN P6       [get_ports ph_spi_data_v_a]  ;# HPA00_N 1.8V
...
set_property PACKAGE_PIN  E9 [get_ports pmod_1]    ;# HDA11
set_property PACKAGE_PIN F13 [get_ports pmod_2]    ;# HDA12
set_property PACKAGE_PIN E12 [get_ports pmod_3]    ;# HDA13
set_property PACKAGE_PIN D10 [get_ports pmod_4]    ;# HDA14
set_property PACKAGE_PIN D9  [get_ports pmod_5]    ;# HDA15
set_property PACKAGE_PIN D13 [get_ports pmod_6]    ;# HDA16
set_property PACKAGE_PIN C13 [get_ports pmod_7]    ;# HDA17
set_property PACKAGE_PIN C10 [get_ports pmod_8]    ;# HDA18
